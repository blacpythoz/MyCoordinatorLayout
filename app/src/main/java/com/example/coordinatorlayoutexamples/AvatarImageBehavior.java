...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private int leftPaddingOfFinalImage;
    private Resources r;
...
//        }
        ...
        leftPaddingOfFinalImage = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 32f, r.getDisplayMetrics());
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, CircleImageView child, View dependency) {
        ...
        if (expandedPercentageFactor < mChangeBehaviorPoint) {
            ...
            float distanceXToSubtract = ((mStartXPosition - mFinalXPosition) * heightFactor) + (child.getHeight() / 2 - leftPaddingOfFinalImage); // SOME CHANGES
...
//            if (expandedPercentageFactor == 0) {
//                dependency.getBackground().setAlpha(255);
//            } else {
//                dependency.getBackground().setAlpha(0);
//            }
        ...
        // CLEAN TRANSITION OF THE TOOLBAR
        dependency.getBackground().setAlpha(255 - (int) (255 * expandedPercentageFactor));
        Log.d("TAG2", "expanded Percentage factor: " + expandedPercentageFactor);
        Log.d("TAG2", "expanded behaviour factor: " + mChangeBehaviorPoint);
        Log.d("TAG2", "expanded get Y: " + dependency.getY());


        float value = actionBarSize - (actionBarSize * expandedPercentageFactor);
        Log.d("TAG3", "value is: " + value + "  and action bar size: " + actionBarSize);
        TabLayout v = (TabLayout) parent.findViewById(R.id.tabLayout);
//        int px2 = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, value / 3, r.getDisplayMetrics());
    ...
    private void maybeInitProperties(CircleImageView child, View dependency) {
        ...
        if (actionBarSize == 0) {
            actionBarSize = dependency.getHeight();
        }
    }
